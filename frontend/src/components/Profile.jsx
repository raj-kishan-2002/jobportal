            ...
            <div className="max-w-7xl mx-auto bg-white border border-gray-200 rounded-2xl my-5 p-8">
                <div className="flex justify-between">
                    <div className="flex items-center gap-4">
                        <Avatar className="h-24 w-24">
                            <AvatarImage src={user?.profile?.profilePhoto || defaultUserLogo} alt="profile" />
                        </Avatar>
                        <div>
                ...
                <div className="my-5">
                    ...
                    <div className="flex items-center gap-3">
                        {
                            user?.profile?.skills.length !== 0 ? user?.profile?.skills.map((item, index) => <Badge className="text-sm" key={index}>{item}</Badge>) : <span>NA</span>
                        }
                    </div>
                </div>
