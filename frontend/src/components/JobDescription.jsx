...
import { APPLICATION_API_END_POINT, JOB_API_END_POINT } from '@/utils/Constatnt';
                ...
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <div className="flex item-center gap-2 mt-4">
                            <Badge className="text-blue-700 font-bold text-sm" variant="ghost"> {singleJob?.position} Positions </Badge>
                            <Badge className="text-[#F83002] font-bold text-sm" variant="ghost"> {singleJob?.jobType} </Badge>
                            <Badge className="text-[#7209B7] font-bold text-sm" variant="ghost"> {singleJob?.salary} </Badge>
                        </div>
                    </div>
                    <Button
